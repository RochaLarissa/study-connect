...
public class InteresseUsuarioServiceImpl implements InteresseUsuarioService {
    ...
    @Override
    public InteresseUsuarioResponse findCompleteById(Long id) {
        var interesse = interesseUsuarioRepository.findById(id).orElseThrow(EntityNotFoundException::new);
        return InteresseUsuarioResponse.build(interesse);
    }
